	soc_system u0 (
		...
		.fifoed_avalon_uart_xbee_rxd                     (<connected-to-fifoed_avalon_uart_xbee_rxd>),                     //        fifoed_avalon_uart_xbee.rxd
		.fifoed_avalon_uart_xbee_txd                     (<connected-to-fifoed_avalon_uart_xbee_txd>),                     //                               .txd
		...
		.hps_i2c1_out_data                               (<connected-to-hps_i2c1_out_data>),                               //                       hps_i2c1.out_data
		.hps_i2c1_sda                                    (<connected-to-hps_i2c1_sda>),                                    //                               .sda
		...
		.hps_i2c2_out_data                               (<connected-to-hps_i2c2_out_data>),                               //                       hps_i2c2.out_data
		.hps_i2c2_sda                                    (<connected-to-hps_i2c2_sda>),                                    //                               .sda
		.hps_i2c2_clk_clk                                (<connected-to-hps_i2c2_clk_clk>),                                //                   hps_i2c2_clk.clk
		.hps_i2c2_scl_in_clk                             (<connected-to-hps_i2c2_scl_in_clk>),                             //                hps_i2c2_scl_in.clk
		...
		.laser_external_connection_on_n                  (<connected-to-laser_external_connection_on_n>),                  //      laser_external_connection.on_n
		.laser_external_connection_txd                   (<connected-to-laser_external_connection_txd>),                   //                               .txd
		.laser_external_connection_rxd                   (<connected-to-laser_external_connection_rxd>),                   //                               .rxd
